{
  ...
  inputs = {
    ...
    pwndbg = {
      url = "github:pwndbg/pwndbg?ref=2026.07.29";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    lidl-to-grocy = {
    ...
    ist-discord-bot = {
      url = "github:ist-bot-team/ist-discord-bot?ref=v3.0.8";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    nixpkgs-build-failure-notifier = {
      url = "github:diogotcorreia/nixpkgs-build-failure-notifier?ref=v0.3.5";
      inputs.nixpkgs.follows = "nixpkgs";
    };
